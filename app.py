...
UI_CHAT_TITLE = os.environ.get("UI_CHAT_TITLE") or "Start chatting now"
UI_CHAT_DESCRIPTION = os.environ.get("UI_CHAT_DESCRIPTION") or "This chatbot is configured to answer your questions - let's see how this works changes made in github"
