...
UI_CHAT_DESCRIPTION = os.environ.get("UI_CHAT_DESCRIPTION") or "I'm an assistant that can help answer questions on Citation products onl. Use me to ask questions, respond to queries, and help draft emails."
