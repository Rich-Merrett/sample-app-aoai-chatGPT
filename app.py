...
UI_CHAT_TITLE = os.environ.get("UI_CHAT_TITLE") or "Citation Product Pro - ISO"
UI_CHAT_DESCRIPTION = os.environ.get("UI_CHAT_DESCRIPTION") or "Ask questions about the range of ISO products Citation has to offer."
