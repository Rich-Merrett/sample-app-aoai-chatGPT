...
UI_CHAT_TITLE = os.environ.get("UI_CHAT_TITLE") or "Sales Product Assist"
UI_CHAT_DESCRIPTION = os.environ.get("UI_CHAT_DESCRIPTION") or "I'm an assistant that can help answer questions on Citation products only. Use me to ask questions, respond to queries, and help draft emails."
