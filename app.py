...
UI_CHAT_TITLE = os.environ.get("UI_CHAT_TITLE") or "Citation Policy Assist"
UI_CHAT_DESCRIPTION = os.environ.get("UI_CHAT_DESCRIPTION") or "Paste in the policy or section of the policy you want re-worded to get an updated version."
