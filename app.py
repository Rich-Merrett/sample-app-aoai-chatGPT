...
UI_CHAT_TITLE = os.environ.get("UI_CHAT_TITLE") or "DBS Assist: Start chatting now"
UI_CHAT_DESCRIPTION = os.environ.get("UI_CHAT_DESCRIPTION") or "Ask about the role and I'll help work out what level of DBS check they need."
