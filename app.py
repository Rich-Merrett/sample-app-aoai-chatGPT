...
UI_CHAT_TITLE = os.environ.get("UI_CHAT_TITLE") or "Food Alert Complaints Assist: Start chatting now"
UI_CHAT_DESCRIPTION = os.environ.get("UI_CHAT_DESCRIPTION") or "Ask for help here"
