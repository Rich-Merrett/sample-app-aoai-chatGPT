...
UI_CHAT_TITLE = os.environ.get("UI_CHAT_TITLE") or "Citation Creative Content Assist"
UI_CHAT_DESCRIPTION = os.environ.get("UI_CHAT_DESCRIPTION") or "Get help with creating your content"
