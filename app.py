...
UI_CHAT_TITLE = os.environ.get("UI_CHAT_TITLE") or "Citation Product Owner Assist: Start chatting now"
UI_CHAT_DESCRIPTION = os.environ.get("UI_CHAT_DESCRIPTION") or "Ask to help you with a range of your daily tasks."
