...
UI_CHAT_TITLE = os.environ.get("UI_CHAT_TITLE") or "ELT - Absence Assist: Start chatting now"
UI_CHAT_DESCRIPTION = os.environ.get("UI_CHAT_DESCRIPTION") or "Ask your questions about the how to handle an absence."
